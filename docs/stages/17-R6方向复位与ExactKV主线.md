...
在同一环境对比 Service、FishMesh load-only、FishMesh exact 和 llm-d precise。重点检查 cache-cold
...
- 新增 [`ADR-002`](../design/decisions/002-lite-exact-kv-routing.md)，正式记录主次关系和 exact
  KV 决策；
- 更新项目章程、架构、实施计划和实验规则；
