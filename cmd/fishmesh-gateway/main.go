...
func logRuntimeConfig(logger *slog.Logger, config servingconfig.Config) {
	logger.Info("gateway listening",
		...
		"admission_initial_target", config.Admission.InitialTarget,
		"admission_tuning_mode", config.AdmissionTuning.Mode,
		"admission_tuning_min_target", config.AdmissionTuning.MinTarget,
		"admission_tuning_max_target", config.AdmissionTuning.MaxTarget,
		"admission_tuning_step", config.AdmissionTuning.Step,
