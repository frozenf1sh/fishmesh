...
func TestAtomicDomainDependencies(t *testing.T) {
	rules := []dependencyRule{
		...
		newRule("internal/serving/requestpath", "internal/serving/backend", "internal/serving/circuit", "internal/serving/discovery", "internal/serving/observation", "internal/serving/routing"),
		...
		newRule("internal/serving/config", "internal/serving/admission", "internal/serving/backend", "internal/serving/circuit", "internal/serving/discovery", "internal/serving/gateway", "internal/serving/identity", "internal/serving/observation", "internal/serving/requestpath", "internal/serving/routing", "internal/serving/transport"),
